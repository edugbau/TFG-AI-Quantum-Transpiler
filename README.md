...
- Los checkpoints nuevos de routing enmascarado usan `MaskablePPO` con `frontier_restricted_edges.v2`, que bloquea el undo-SWAP inmediato cuando hay alternativas. Los checkpoints `v1`, `PPO` y `DQN` siguen siendo evaluables con su contrato historico.
